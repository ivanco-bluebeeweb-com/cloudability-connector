"""Pydantic schemas for Cloudability Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Cloudability.")
    api_key: str = Field(description="FinOps API Key")
    base_url: str = Field(default="https://api.cloudability.com/v3", description="Cloudability API base URL.")
...
class GetCostRecordParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    costrecord_id: str = Field(description="Cloudability CostRecord ID.")
