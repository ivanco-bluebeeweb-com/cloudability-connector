# Apptio Cloudability Connector — UI Component Plan
...
- **Центральная зона:** Карточки статуса подключения, таблица сущностей (отчеты о затратах (/reporting)), журнал операций.
