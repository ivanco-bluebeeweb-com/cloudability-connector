"""HTTP client for Apptio Cloudability (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.cloudability.com"

class ApptioCloudabilityClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-cloudability/0.1.0"
        }
