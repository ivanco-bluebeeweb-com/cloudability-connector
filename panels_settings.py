"""Settings panel for Apptio Cloudability Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__cloudability_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=cloudability_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_cloudability"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Apptio Cloudability Settings & Accounts", level=2),
